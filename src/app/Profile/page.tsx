        ...
        >
          ...
          >
            <Link href="https://www.facebook.com/ryouma.yoshitaka.1">
              ...
              <Center>
                <Text fontSize="lg" color="sky.900">
                  Facebook
                </Text>
              </Center>
            </Link>
          ...
          >
            <Link href="https://discordapp.com/users/1078302551524515840">
              ...
              <Center>
                <Text fontSize="lg" color="sky.700">
                  Discord
                </Text>
              </Center>
            </Link>
          ...
          >
            <Link href="/Contact">
              ...
              <Center>
                <Text fontSize="lg" color="sky.500">
                  E-mail
                </Text>
              </Center>
            </Link>
        ...
        >
          ...
          >
            <ExportedImage
              src={ProfileImage}
              alt="プロフィール画像"
              style={{ width: 'auto', borderRadius: 16 }}
            />
          </GridItem>
          <GridItem
            colSpan={3}
          ...
          >
            <Text p="2">
              鈴鹿高専電子情報工学科の吉髙
              僚眞です。よろしくお願いします。いろんな技術を触っています。電子工作などもやっています。
            </Text>
          </GridItem>
        </Grid>
      </Box>
